    ...
    <section className="relative py-28 bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-950 text-zinc-100 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-6">
        ...
        <p className="mt-8 text-lg text-zinc-300 max-w-3xl mx-auto text-center">
          Proces implementacije sigurnosnog sistema je brz, diskretan i
          prilagođen postojećem prostoru — bez komplikacija.
        </p>
        ...
        <div className="mt-20 grid md:grid-cols-4 gap-10">
          ...
          <div className="relative bg-zinc-900/60 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-xl hover:border-blue-500/40 transition">
            ...
            <p className="mt-3 text-zinc-400">
              Analiza prostora, ulaza, kritičnih tačaka i nivoa zaštite koji vam
              je potreban.
            </p>
          </div>
          ...
          <div className="relative bg-zinc-900/60 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-xl hover:border-blue-500/40 transition">
            ...
            <p className="mt-3 text-zinc-400">
              Odabir kamera, senzora i kontrolnih tačaka prema vašem prostoru i
              navikama.
            </p>
          </div>
          ...
          <div className="relative bg-zinc-900/60 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-xl hover:border-blue-500/40 transition">
            ...
            <p className="mt-3 text-zinc-400">
              Diskretna instalacija kamera, senzora i kontrolnih uređaja bez
              narušavanja prostora.
            </p>
          </div>
          ...
          <div className="relative bg-zinc-900/60 backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-xl hover:border-blue-500/40 transition">
            ...
            <p className="mt-3 text-zinc-400">
              Testiranje sistema, podešavanje obaveštenja i obuka za svakodnevno
              korišćenje.
            </p>
          </div>
